<footer>
    <div class="container d-flex justify-content-center align-item-center">
        <div class="footer-box p-4 my-5 row">
            <div class="col-6">
                <div class="d-flex justify-content-start">
                    <svg width="30px" viewBox="0 -0.5 24 24" id="meteor-icon-kit__solid-home" fill="none"
                    ...
                    <p class="text-color-primary fw-bold mb-0 mt-2 px-2">NHACHOTHUE.COM</p>
                </div>
                <p class="my-3 "><span class="text-color-primary fst-italic">Nhachothue.com</span> là một nền tảng tương tác trực tuyến tiên tiến, mang đến
                    trải nghiệm độc đáo cho người dùng trong quá trình tìm kiếm và cho thuê phòng trọ. Với giao diện đơn
                    giản, dễ sử dụng và tối ưu hóa cho mọi thiết bị, trang web giúp người dùng tiết kiệm thời gian và nỗ
                    lực trong việc tìm kiếm nơi ở lý tưởng.</p>
            </div>
            <div class="col-6">
                <h5 class="text-color-primary">Liên kết</h5>
                <div class="row row-cols-2">
                    <p class="my-1">Đăng ký</p>
                    <p class="my-1">Đăng nhập</p>
                    <p class="my-1">Tài khoản</p>
                    <p class="my-1">Nạp tiền</p>
                    <p class="my-1">Đăng tin</p>
                    <p class="my-1">Xem danh sách</p>
                    <p class="my-1">Bảng giá đăng tin</p>
                    <p class="my-1">Tin khuyến mãi</p>
                </div>
            </div>
        </div>
    </div>
